 ...
 * @author jesus
 */
public class SemanalesBajas extends javax.swing.JInternalFrame {
    private AltasBajas altasBajas;
    /**
     * Creates new form SemanalesBajas
     */
    public SemanalesBajas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Bajas semanales");

        jLabel3.setForeground(new java.awt.Color(255, 0, 0));
        jLabel3.setText("Clientes ACTIVOS");

        jLabel1.setFont(new java.awt.Font("Dialog", 0, 24)); // NOI18N
        jLabel1.setText("Bajas semanales");
