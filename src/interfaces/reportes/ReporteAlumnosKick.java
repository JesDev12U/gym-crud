 ...
 */
public class ReporteAlumnosKick extends javax.swing.JInternalFrame {

    /**
     * Creates new form ReporteAlumnosKick
     */
    public ReporteAlumnosKick() {
        initComponents();
        mostrarDatosTabla();
    ...
    private void mostrarDatosTabla(){
        if(MySQLConnection.conectarBD()){
            String query = "SELECT ID_Kick, CONCAT(Nom_Kick, ' ', ApPat_Kick, ' ', ApMat_Kick) AS 'Nombre completo', FecNac_Kick,\n" +
            ...
            model.addColumn("Horario de clase");
            model.addColumn("Teléfono");
            model.addColumn("Estado del alumno");
            model.addColumn("ID del pago de inscripción");
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Reporte de alumnos de Kick Boxing");

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel1.setText("Reporte de alumnos de Kick Boxing");
