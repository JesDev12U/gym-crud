 ...
 */
public class ReportePagosKick extends javax.swing.JInternalFrame {

    /**
     * Creates new form ReportePagosKick
     */
    public ReportePagosKick() {
        initComponents();
        mostrarDatosTabla();
    ...
    private void mostrarDatosTabla(){
        if(MySQLConnection.conectarBD()){
            String query = "SELECT p.ID_PagoK, p.ID_Kick, CONCAT(k.Nom_Kick, ' ', k.ApPat_Kick, ' ', k.ApMat_Kick) AS 'Nombre completo', \n" +
            "p.ID_Pago, FecVig_PagoK\n" +
            "FROM PagoKick p\n" +
            "INNER JOIN InscripcionKick k ON p.ID_Kick = k.ID_Kick;";
            Statement st;
            ...
            model.addColumn("ID del pago Kick Boxing");
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Reporte de pagos Kick Boxing");

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel1.setText("Reporte de pagos Kick Boxing");
