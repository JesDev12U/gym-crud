 ...
 */
public class ReporteClientesMensuales extends javax.swing.JInternalFrame {

    /**
     * Creates new form ReporteClientesMensuales
     */
    public ReporteClientesMensuales() {
        initComponents();
        mostrarDatosTabla();
    ...
    private void mostrarDatosTabla(){
        if(MySQLConnection.conectarBD()){
            String query = "SELECT ID_Cli, CONCAT(Nom_Cli, ' ', ApPat_Cli, ' ', ApMat_Cli) AS 'Nombre completo', Est_Cli, ID_Ins\n" +
            "FROM Clientes;";
            Statement st;
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Reporte de clientes mensuales");

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel1.setText("Reporte de clientes mensuales");
