 ...
 */
public class ReporteMensualidades extends javax.swing.JInternalFrame {

    /**
     * Creates new form ReporteMensualidades
     */
    ...
    private void mostrarDatosTabla(){
        if(MySQLConnection.conectarBD()){
            String query = "SELECT m.ID_Men, m.ID_Cli, CONCAT(c.Nom_Cli, ' ', c.ApPat_Cli, ' ', c.ApMat_Cli) AS 'Nombre completo',\n" +
            "m.ID_Pago\n" +
            "FROM Mensualidades m\n" +
            "INNER JOIN Clientes c on c.ID_Cli = m.ID_Cli;";
            Statement st;
            ...
            model.addColumn("ID de la mensualidad");
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Reporte de mensualidades");

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel1.setText("Reporte de mensualidades");
