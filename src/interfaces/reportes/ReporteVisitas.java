 ...
 */
public class ReporteVisitas extends javax.swing.JInternalFrame {

    /**
     * Creates new form ReporteVisitas
     */
    public ReporteVisitas() {
        initComponents();
        mostrarDatosTabla();
    ...
    private void mostrarDatosTabla(){
        if(MySQLConnection.conectarBD()){
            String query = "SELECT ID_Vis, CONCAT(Nom_Vis, ' ', ApPat_Vis, ' ', ApMat_Vis) AS 'Nombre completo', ID_Pago\n" +
            "FROM Visitas;";
            Statement st;
            ...
            model.addColumn("ID de la visita");
