 ...
 */
public class ReporteInscripcionesMensuales extends javax.swing.JInternalFrame {

    /**
     * Creates new form ReporteInscripciones
     */
    public ReporteInscripcionesMensuales() {
        initComponents();
        mostrarDatosTabla();
    ...
    private void mostrarDatosTabla(){
        if(MySQLConnection.conectarBD()){
            String query = "SELECT i.ID_Ins, c.ID_Cli, CONCAT(c.Nom_Cli, ' ', c.ApPat_Cli, ' ', c.ApMat_Cli) AS 'Nombre completo', i.Fec_Ins, i.ID_Pago\n" +
            "FROM Inscripciones i\n" +
            "INNER JOIN Clientes c ON c.ID_Ins = i.ID_Ins;";
            Statement st;
            ...
            model.addColumn("ID de la inscripción");
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Reporte de inscripciones mensuales");

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel1.setText("Reporte de inscripciones mensuales");
