 ...
 */
public class ReporteClientesSemanales extends javax.swing.JInternalFrame {

    /**
     * Creates new form ReporteClientesSemanales
     */
    public ReporteClientesSemanales() {
        initComponents();
        mostrarDatosTabla();
    ...
    private void mostrarDatosTabla(){
        if(MySQLConnection.conectarBD()){
            String query = "SELECT ID_Sem, CONCAT(Nom_Sem, ' ', ApPat_Sem, ' ', ApMat_Sem) AS 'Nombre completo', Est_Sem, ID_Pago\n" +
            "FROM ClienteSemanal;";
            Statement st;
            ...
            model.addColumn("Estado del cliente");
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Reporte de clientes semanales");

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel1.setText("Reporte de clientes semanales");
